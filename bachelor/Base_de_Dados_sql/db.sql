...
Insert INTO ARTIGO(Titulo,Autor,NumPaginas,Volume,Tipo,Localizacao)    
VALUES 
...
'Livro didático','3'),
  ...
  '474',NULL,'Livro didático','7'),
  ('Renewable energy forecasting : extreme quantiles, data privacy and monetization',
  'Gonçalves, Carla Sofia da Silva','135',NULL,'Tese de Doutoramento','8'),
  (NULL,NULL,NULL,NULL,'Calculadora','1'),
  (NULL,NULL,NULL,NULL,'Calculadora','1'),
  (NULL,NULL,NULL,NULL,'Calculadora','1'),
  (NULL,NULL,NULL,NULL,'Calculadora','1'),
  (NULL,NULL,NULL,NULL,'Calculadora','1'),
