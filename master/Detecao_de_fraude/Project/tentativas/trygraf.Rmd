...
dados_sem_na <- dados_sem_na[, -which(names(dados_sem_na) == "id")]
...
dados_preenchidos <- dados_preenchidos[, -which(names(dados_preenchidos) == "id")]
...
dados_numericos_sem_na <- as.data.frame(lapply(dados_sem_na, as.numeric))
dados_numericos_preenchidos <- as.data.frame(lapply(dados_preenchidos, as.numeric))


dados_normalizados <- scale(dados_numericos_sem_na[, -which(names(dados_numericos_sem_na) == "is_fraud")])
dados_normalizados_p <- scale(dados_numericos_preenchidos[, -which(names(dados_numericos_preenchidos) == "is_fraud")])
