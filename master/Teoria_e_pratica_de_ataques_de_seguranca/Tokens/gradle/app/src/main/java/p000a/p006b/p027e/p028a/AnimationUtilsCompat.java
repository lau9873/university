...
public class AnimationUtilsCompat {
    /* renamed from: a */
    public static Interpolator m10642a(Context context, int i) {
        ...
        try {
            try {
                ...
                Interpolator m10641a = m10641a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return m10641a;
    ...
    */
    public static android.view.animation.Interpolator m10641a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p006b.p027e.p028a.AnimationUtilsCompat.m10641a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
