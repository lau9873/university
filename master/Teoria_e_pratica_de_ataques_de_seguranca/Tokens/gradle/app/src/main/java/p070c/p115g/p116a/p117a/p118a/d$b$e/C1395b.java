...
/* renamed from: c.g.a.a.a.d$b$e.b */
/* loaded from: classes.dex */
public class C1395b extends C1373d.AbstractC1382c {
    ...
    public C1373d.InterfaceC1375b mo4560a(Context context, JSONObject jSONObject, int i, int i2, Object... objArr) {
        if (i == 221) {
            if (i2 >= 0) {
                if (context != null) {
                    return new C1391a(context, jSONObject, i, i2);
                }
                throw new Exception("context can't be null for Enrolment task");
            }
            throw new Exception("target id cannot be <0 for Enrolment task");
        }
