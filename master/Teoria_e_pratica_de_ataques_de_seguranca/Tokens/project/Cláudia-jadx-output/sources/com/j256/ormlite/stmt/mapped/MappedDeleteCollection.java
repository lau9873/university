...
public class MappedDeleteCollection<T, ID> extends BaseMappedStatement<T, ID> {
    ...
    public static void appendWhereIds(DatabaseType databaseType, FieldType fieldType, StringBuilder sb, int i2, FieldType[] fieldTypeArr) {
        sb.append("WHERE ");
    ...
    public static <T, ID> MappedDeleteCollection<T, ID> build(DatabaseType databaseType, TableInfo<T, ID> tableInfo, int i2) {
