...
public class DatabaseTableConfigUtil {
    ...
    public static void assignConfigField(int i2, DatabaseFieldConfig databaseFieldConfig, Field field, Object obj) {
        switch (i2) {
            case 1:
    ...
    public static DatabaseFieldConfig buildConfig(DatabaseField databaseField, String str, Field field) {
        ...
        if (invocationHandler.getClass() == annotationFactoryClazz && (obj = elementsField.get(invocationHandler)) != null) {
            ...
            for (int i2 = 0; i2 < configFieldNums.length; i2++) {
                Object obj2 = valueField.get(objArr[i2]);
                if (obj2 != null) {
                    assignConfigField(configFieldNums[i2], databaseFieldConfig, field, obj2);
                }
            }
        ...
        try {
            ...
            if (invocationHandler.getClass() == annotationFactoryClazz && (obj = elementsField.get(invocationHandler)) != null && obj.getClass() == cls) {
                ...
                for (int i2 = 0; i2 < objArr.length; i2++) {
                    iArr[i2] = configFieldNameToNum((String) nameField.get(objArr[i2]));
                }
                return iArr;
            }
