...
/* JADX WARN: Classes with same name are omitted:
  hfsexplorer-0_21-src.zip:dist/lib/hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel.class
 */
/* loaded from: hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel.class */
public class CatalogInfoPanel extends JPanel {
    ...
    public CatalogInfoPanel(final BaseHFSFileSystemView fsView) {
        ...
        CommonBTNode iNode = fsView.getCatalogNode(-1L);
        if (iNode == null) {
            DefaultTreeModel model = new DefaultTreeModel(new FileSystemBrowser.NoLeafMutableTreeNode("<empty>"));
            dirTree.setModel(model);
            return;
        }
        DefaultMutableTreeNode rootNode = new FileSystemBrowser.NoLeafMutableTreeNode(new BTNodeStorage(iNode, "Catalog root"));
        expandNode(rootNode, iNode, fsView);
        DefaultTreeModel model2 = new DefaultTreeModel(rootNode);
        dirTree.setModel(model2);
        dirTree.addTreeWillExpandListener(new TreeWillExpandListener() { // from class: org.catacombae.hfsexplorer.gui.CatalogInfoPanel.1
            public void treeWillExpand(TreeExpansionEvent e2) throws ExpandVetoException {
                ...
                if (obj instanceof DefaultMutableTreeNode) {
                    ...
                    if (obj2 instanceof BTNodeStorage) {
                        ...
                        CatalogInfoPanel.this.expandNode(dmtn, node, fsView);
                        return;
                    }
            ...
            public void valueChanged(TreeSelectionEvent te) {
                ...
                if (o instanceof DefaultMutableTreeNode) {
                    ...
                    if (o2 instanceof BTNodeStorage) {
                        ...
                        clRoot.show(CatalogInfoPanel.this.infoPanel, DatabaseFieldConfigLoader.FIELD_NAME_INDEX);
                        return;
                        ...
                        if (rec instanceof CommonHFSCatalogFileRecord.HFSPlusImplementation) {
                            ...
                            if (fld instanceof CommonHFSCatalogFolder.HFSPlusImplementation) {
                                HFSPlusCatalogFolder underlying2 = ((CommonHFSCatalogFolder.HFSPlusImplementation) fld).getUnderlying();
                                folderInfoPanel.setFields(underlying2);
                        ...
                        clRoot.show(CatalogInfoPanel.this.infoPanel, "leaf");
                        return;
                    } else {
    ...
    /* JADX WARN: Classes with same name are omitted:
      hfsexplorer-0_21-src.zip:dist/lib/hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel$3.class
     */
    /* renamed from: org.catacombae.hfsexplorer.gui.CatalogInfoPanel$3  reason: invalid class name */
    /* loaded from: hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel$3.class */
    ...
    public void expandNode(DefaultMutableTreeNode dmtn, CommonBTNode node, BaseHFSFileSystemView fsView) {
        if (node instanceof CommonHFSCatalogIndexNode) {
            Iterator i$ = ((CommonHFSCatalogIndexNode) node).getBTRecords().iterator();
            while (i$.hasNext()) {
                ...
                dmtn.add(new FileSystemBrowser.NoLeafMutableTreeNode(new BTNodeStorage(curNode, key.getParentID().toLong() + ":" + fsView.decodeString(key.getNodeName()))));
            }
            ...
            for (CommonHFSCatalogLeafRecord rec2 : recs) {
                dmtn.add(new DefaultMutableTreeNode(new BTLeafStorage(rec2, rec2.getKey().getParentID().toLong() + ":" + fsView.decodeString(rec2.getKey().getNodeName()))));
            }
        } else {
    ...
    /* JADX WARN: Classes with same name are omitted:
      hfsexplorer-0_21-src.zip:dist/lib/hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel$BTNodeStorage.class
     */
    /* loaded from: hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel$BTNodeStorage.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Classes with same name are omitted:
      hfsexplorer-0_21-src.zip:dist/lib/hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel$BTLeafStorage.class
     */
    /* loaded from: hfsx.jar:org/catacombae/hfsexplorer/gui/CatalogInfoPanel$BTLeafStorage.class */
