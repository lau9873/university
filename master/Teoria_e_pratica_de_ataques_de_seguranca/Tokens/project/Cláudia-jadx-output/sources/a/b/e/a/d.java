...
public class d {
    public static Interpolator a(Context context, int i2) {
        ...
        try {
            try {
                if (i2 == 17563663) {
                    return new a.b.g.k.f0.a();
                }
                if (i2 == 17563661) {
                    return new a.b.g.k.f0.b();
                }
                if (i2 == 17563662) {
                    return new a.b.g.k.f0.c();
                }
    ...
    */
    public static android.view.animation.Interpolator a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) {
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: a.b.e.a.d.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
