...
public class DataModelDBOs$TableStopInfo implements Parcelable {
    ...
    /* renamed from: pt.card4b.backendbeacons.DataModelDBOs$TableStopInfo$a */
    /* loaded from: classes.dex */
    public class C2690a implements Parcelable.Creator<DataModelDBOs$TableStopInfo> {
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: a */
        public DataModelDBOs$TableStopInfo[] newArray(int i) {
            return new DataModelDBOs$TableStopInfo[i];
        }
    }
