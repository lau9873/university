...
/* JADX WARN: Classes with same name are omitted:
  hfsexplorer-0_21-src.zip:dist/lib/hfsx.jar:org/catacombae/hfsexplorer/testcode/RepairMyGPTPlease.class
 */
/* loaded from: hfsx.jar:org/catacombae/hfsexplorer/testcode/RepairMyGPTPlease.class */
public class RepairMyGPTPlease {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (originalGpt.isValid() && gpt.isValid()) {
            ...
            backupFile2.close();
            System.out.println("done!");
            byte[] efiSystemPartitionType = {40, 115, 42, -63, 31, -8, -46, 17, -70, 75, 0, -96, -55, 62, -55, 59};
            byte[] microsoftBasicDataType = {-94, -96, -48, -21, -27, -71, 51, 68, -121, -64, 104, -74, -73, 38, -103, -57};
            byte[] appleHfsType = {0, 83, 70, 72, 0, 0, -86, 17, -86, 17, 0, 48, 101, 67, -20, -84};
