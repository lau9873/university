...
public final class s {
    ...
    public static final int[] BackgroundStyle = {16843534, 2130903540};
    public static final int[] ButtonBarLayout = {2130903082};
    public static final int[] CheckBoxPreference = {16843247, 16843248, 16843249, m.disableDependentsState, m.summaryOff, m.summaryOn};
    ...
    public static final int[] DialogPreference = {16843250, 16843251, 16843252, 16843253, 16843254, 16843255, m.dialogIcon, m.dialogLayout, m.dialogMessage, m.dialogTitle, m.negativeButtonText, m.positiveButtonText};
    ...
    public static final int[] ListPreference = {16842930, 16843256, m.entries, m.entryValues};
    ...
    public static final int[] MultiSelectListPreference = {16842930, 16843256, m.entries, m.entryValues};
    ...
    public static final int[] Preference = {16842754, 16842765, 16842766, 16842994, 16843233, 16843238, 16843240, 16843241, 16843242, 16843243, 16843244, 16843245, 16843246, 16843491, 16844124, 16844129, m.allowDividerAbove, m.allowDividerBelow, m.defaultValue, m.dependency, m.enabled, m.fragment, 2130903352, m.iconSpaceReserved, m.isPreferenceVisible, m.key, 2130903387, m.order, m.persistent, m.selectable, m.shouldDisableView, m.singleLineTitle, m.summary, 2130903654, m.widgetLayout};
    public static final int[] PreferenceFragment = {16842994, 16843049, 16843050, m.allowDividerAfterLastItem};
    public static final int[] PreferenceFragmentCompat = {16842994, 16843049, 16843050, m.allowDividerAfterLastItem};
    public static final int[] PreferenceGroup = {16843239, m.initialExpandedChildrenCount, m.orderingFromXml};
    public static final int[] PreferenceImageView = {16843039, 16843040, m.maxHeight, m.maxWidth};
    public static final int[] PreferenceTheme = {m.checkBoxPreferenceStyle, m.dialogPreferenceStyle, m.dropdownPreferenceStyle, m.editTextPreferenceStyle, m.preferenceActivityStyle, m.preferenceCategoryStyle, m.preferenceFragmentCompatStyle, m.preferenceFragmentListStyle, m.preferenceFragmentPaddingSide, m.preferenceFragmentStyle, m.preferenceHeaderPanelStyle, m.preferenceInformationStyle, m.preferenceLayoutChild, m.preferenceListStyle, m.preferencePanelStyle, m.preferenceScreenStyle, m.preferenceStyle, m.preferenceTheme, m.ringtonePreferenceStyle, m.seekBarPreferenceStyle, m.switchPreferenceCompatStyle, m.switchPreferenceStyle, m.yesNoPreferenceStyle};
    ...
    public static final int[] SeekBarPreference = {16842994, 16843062, m.adjustable, m.min, m.seekBarIncrement, m.showSeekBarValue};
    ...
    public static final int[] SwitchPreference = {16843247, 16843248, 16843249, 16843627, 16843628, m.disableDependentsState, m.summaryOff, m.summaryOn, m.switchTextOff, m.switchTextOn};
    public static final int[] SwitchPreferenceCompat = {16843247, 16843248, 16843249, 16843627, 16843628, m.disableDependentsState, m.summaryOff, m.summaryOn, m.switchTextOff, m.switchTextOn};
