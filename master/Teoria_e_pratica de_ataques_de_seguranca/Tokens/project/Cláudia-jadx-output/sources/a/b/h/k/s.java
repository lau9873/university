...
public class s {
    ...
    public static final int[] f1938c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    public final ProgressBar f1939a;

    /* renamed from: b  reason: collision with root package name */
    public Bitmap f1940b;

    public s(ProgressBar progressBar) {
        this.f1939a = progressBar;
    }

    public void a(AttributeSet attributeSet, int i2) {
        l1 a2 = l1.a(this.f1939a.getContext(), attributeSet, f1938c, i2, 0);
        Drawable c2 = a2.c(0);
        if (c2 != null) {
            this.f1939a.setIndeterminateDrawable(a(c2));
        }
        Drawable c3 = a2.c(1);
        if (c3 != null) {
            this.f1939a.setProgressDrawable(a(c3, false));
        }
        a2.a();
    }
    ...
    public final Drawable a(Drawable drawable, boolean z) {
        if (drawable instanceof a.b.g.c.j.f) {
            a.b.g.c.j.f fVar = (a.b.g.c.j.f) drawable;
            Drawable a2 = fVar.a();
            if (a2 != null) {
                fVar.a(a(a2, z));
                return drawable;
